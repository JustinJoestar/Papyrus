-- ============================================================
-- Papyrus — Trade Rate Limiting
-- Run in Supabase SQL Editor after trading.sql
-- ============================================================

-- Add last_trade_at column to profiles
alter table public.profiles
  add column if not exists last_trade_at timestamptz;

-- ============================================================
-- Updated execute_trade with 1-second rate limit
-- ============================================================
