  ...
  return (
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-12">
      ...
      <form onSubmit={save} className="rounded-2xl p-6 mb-8 space-y-4" style={{ background: "var(--surface)", border: "1px solid var(--border-mid)" }}>
        ...
        <button type="submit" disabled={saving} className="font-bold font-mono text-sm tracking-[0.1em] px-6 py-2.5 rounded-xl text-[var(--ink-on-gold)] disabled:opacity-40" style={{ background: "linear-gradient(135deg, var(--gold-dim) 0%, var(--gold) 50%, var(--gold-bright) 100%)" }}>
