...
> = {
  achievement: {
    ...
    bgGlow: "rgba(201,162,78,0.12)",
    iconBg: "rgba(201,162,78,0.15)",
  },
  leaderboard: {
    label: "Leaderboard",
    Icon: Crown,
    accentColor: "#a98bc8",
    bgGlow: "rgba(169,139,200,0.1)",
    iconBg: "rgba(169,139,200,0.15)",
  },
  league: {
    label: "League Update",
    Icon: Trophy,
    accentColor: "#8fa3bc",
    bgGlow: "rgba(143,163,188,0.1)",
    iconBg: "rgba(143,163,188,0.15)",
  },
  reset: {
    label: "Weekly Reset",
    Icon: RefreshCw,
    accentColor: "#4fa97f",
    bgGlow: "rgba(79,169,127,0.1)",
    iconBg: "rgba(79,169,127,0.15)",
  },
  info: {
    label: "Notice",
    Icon: Bell,
    accentColor: "var(--text-2)",
    bgGlow: "rgba(160,150,130,0.06)",
    iconBg: "rgba(160,150,130,0.1)",
  },
};
