    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round"
          d="M3 13.5l4.5-4.5 4 4L16 8l5 5" />
      </svg>
    ),
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="text-sm font-mono transition-colors px-3 py-1.5"
          ...
          <Link
            href="/auth/signup"
            className="text-sm font-bold font-mono px-4 py-2 rounded-xl transition-all"
            style={{
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 pt-24 pb-20 text-center">
        ...
        >
          Paper trade.{" "}
          <span className="text-gold-shimmer">Real competition.</span>
        </h1>

        <p className="text-lg max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: "var(--text-3)" }}>
          Get $10,000 in virtual cash. Trade crypto, stocks, and commodities
          with live prices. Compete on the global leaderboard. Reset weekly.
        </p>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link
            href="/dashboard/market"
            className="font-mono text-sm px-8 py-3.5 rounded-xl transition-all duration-200"
            style={{
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 pb-20">
        <div
          className="rounded-2xl px-8 py-6 grid grid-cols-5 gap-4 divide-x"
          style={{
        ...
        >
          {STATS.map((s) => (
            <div key={s.label} className="text-center px-4">
              <p className="font-mono font-bold text-xl mb-1 text-gold-gradient">
                {s.value}
              </p>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 pb-24">
        <p
          className="font-mono text-[10px] tracking-[0.28em] uppercase text-center mb-3"
          style={{ color: "var(--text-3)" }}
        >
          Everything you need
        </p>
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-8 pb-24 text-center">
        ...
        >
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 60% 80% at 50% 120%, rgba(201,168,76,0.10) 0%, transparent 65%)",
            }}
          />
          <div
